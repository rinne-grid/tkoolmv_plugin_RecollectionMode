...
{"name":"RecollectionMode_back_to_menu_and_title_patch","status":false,"description":"メニューから回想モードを呼び出せるようにします","parameters":{"コマンド追加位置":"5","「回想」コマンドの名称":"回想モード","「戻る」コマンドの名称":"メニューに戻る"}}
];
